   ...
   <body class="size-1520 primary-color-red background-dark">
        ...
        <nav class="s-12 grid background-none background-primary-hightlight">
           ...
           <div class="top-nav s-12 l-9"> 
              <ul class="top-ul right chevron">
                ...
                <li><a href="about-us.html">در باره ما</a></li>
                <li><a href="services.html">سرویس ها</a></li>
                <li><a href="gallery.html">کتابخانه</a></li>
      ...
      <main role="main">
        ...
        <section class="grid section margin-bottom background-dark">
          <h2 class="s-12 l-6 center text-thin text-size-30 text-white text-uppercase margin-bottom-30"> <b> کتاب خانه بازی </b>برای شما چه چیزهایی را فراهم میسازد  </h2>
          <p class="s-12 l-6 center">شما در این جا میتوانید انواع بازی های مختلف در پلتفرم های مختلف در پیدا کنید کتابخانه بازی به شما کمک میکند که هر بازی در نوع ژانری پیدا و بازی کنید ولذت ببرید</p>
        </section>
